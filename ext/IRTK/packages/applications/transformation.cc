...
int main(int argc, char **argv)
{
    ...
    int target_x1, target_y1, target_z1, target_t1, target_x2, target_y2, target_z2, target_t2;
    int source_x1, source_y1, source_z1, source_t1, source_x2, source_y2, source_z2, source_t2;
    ...
    if ((target_x1 != 0) || (target_x2 != target->GetX()) ||
        ...
        (target_z1 != 0) || (target_z2 != target->GetZ())) {
            ...
            region->PutRegion(target_x1, target_y1, target_z1, target_t1, target_x2, target_y2, target_z2, target_t2);
            region->Run();
    }
    ...
    if ((source_x1 != 0) || (source_x2 != source->GetX()) ||
        ...
        (source_z1 != 0) || (source_z2 != source->GetZ())) {
            ...
            region->PutRegion(source_x1, source_y1, source_z1, source_t1, source_x2, source_y2, source_z2, source_t2);
            region->Run();
    }
