...
template class anisoDiffusion<unsigned char>;
template class anisoDiffusion<short>;
template class anisoDiffusion<unsigned short>;
template class anisoDiffusion<float>;
template class anisoDiffusion<double>;
